    ...
    return (
        <Grid container direction="column" className={classes.mainContainer}>
            ...
            <Grid item> {/*-----The Revolution Block -----*/}
                <Grid container style={{height: "100em", marginTop:"12em"}} 
                alignItems="center" justify="center">
                    ...
                    <div className={classes.therevolutionBackground} />
                </Grid>
                 ...
                 direction={matchesXS ? "column": "row"}>
                        ...
                        <Grid container style={{marginBottom: matchesXS ? "10em" : 0}} direction="column">
                            ...
                            <Grid item>
                                ...
                                onClick={ () => props.setValue(3)}
                                 variant="outlined" className={classes.learnButtonHero} >
                                    <span style={{marginRight: 10}} >Learn More</span> 
                                    <ButtonArrow width={15} height={15}
                                                fill= "white" />
                                </Button>
                    ...
                    <Grid item sm style={{ marginRight: matchesXS ? 0 : matchesSM ? "2em":"5em", textAlign:  matchesXS ? "center" : "right"}}>
                        <Grid container direction="column">
                            ...
                            <span role="img" aria-label="waving hand">👋</span></Typography>
                            <Grid item>
                                <Button style={{color: "white" , borderColor:"white"}} 
